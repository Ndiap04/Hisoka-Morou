...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph//file/201d45ea1cb7553dc8ba2.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n🌟 Premium Bot Groups:\n⭔ 10k/bulan (bisa akses bersama teman kamu)\n⭔ 5k/minggu (bisa akses semua teman kamu)\n\n🌟 Premium Bot:\n⭔ 8k/bulan (Bisa Akses Perintah Premium)\n\nBisa semua payment-Dengan payment apapun\n\nJika kamu ingin berdonasi silahkan scan Qris diatas lalu kirim via WhatsApp owner\nhttps://wa.me/6285894831504 (Owner)\n\nContack Selengkapnya : \n\n⭔ Telegram : t.me/pikyus1 \n⭔ Instagram : @ndiap04` }, { quoted: m })
            }
            break
                case 'assalamualaikum': case 'hi': case 'halo': case 'bot': case 'p': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph//file/b806d93f2dc72157c9874.jpg' }, caption: `*Hai Kak ${m.pushName}*!\n\nSelamat datang dibot BottyCu Store\n⭔ Mohon gunakan bot dengan bijak \n⭔ Bot akan terus berjalan jika didonasikan\n\n⛔WARNING⛔\n\nBot ini berjalan dengan server yang berbayar\nMohon donasikan beberapapun duit yang kamu punya, agar bot ini tetap berjalan dengan baik\n\nSelengkapnya : \n\n⭔ Ketik : *menu* , untuk melihat fungsi bot\n⭔ Ketik : *donasi* , untuk melakukan donasi\n⭔ Ketik : *owner* , untuk menghubungi owner bot\n⭔ Ketik : *selengkapnya* , untuk lihat selengkapnya dari bot` }, { quoted: m })
                }
            break
            case 'selengkapnya': {
                m.reply('Bot Version : *v25.03.23*\n\n Dont Forget Give Star\n\nDonate : 6285894831504 (Semua Payment)\nTelegram : t.me/pikyus1\nInstagram : @ndiap04\n\n Jangan Lupa Donasi')
            }
            break
            case 'chat': {
