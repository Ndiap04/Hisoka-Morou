...
case 'menfes': case 'menfess': {
            ...
            await hisoka.sendText(m1 + '@s.whatsapp.net', thumbnail, pjtxt, kawk, m, {mentions: ments, quoted: kafloc})
            let akhji = `Pesan Telah Terkirim\nKe @${mq1.split('@')[0]}`
            await hisoka.sendImage(m.chat, thumbnail, akhji, nyoutube, m, {mentions: ments})
            }
            break
             case 'tiktoknowm': {
