...
let gdyr = await hisoka.sendMessage(from, pepekntl, { quoted : m })
try {
...
.on('finish', async () => {
await hisoka.sendMessage(from, { video: fs.readFileSync(mp4File), caption: mess.success, gifPlayback: false }, { quoted: gdyr })
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'donate': {
         ...
         case 'premium1': {
            ...
            break
            case 'premium': {
                m.reply('🎁 Paket Premium:\n*premium1* - bot groups\n*premium2* - userbot.')
            }
            break
            case 'premium2': {
                m.reply('Paket Premium 2 Belum Tersedia')
            }
            break
            case 'chat': {
...
case 'menfes': case 'menfess': {
            ...
            await hisoka.sendText(m1 + '@s.whatsapp.net', pjtxt, kwak, m)
...
└───────⭓`
                let btn = [{
                                urlButton: {
                                    displayText: 'Telegram Owner',
                                    url: 'http://t.me/pikyus1'
                                }
                            }]
                         let setbot = db.data.settings[botNumber]
