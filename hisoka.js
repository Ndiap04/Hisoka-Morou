...
let gedeyeer = await hisoka.sendMessage(from, xnxxBokepSitus, { quoted : m })
try {
...
.on('finish', async () => {
await hisoka.sendMessage(from, { audio: fs.readFileSync(mp3File), mimetype: 'audio/mp4' }, { quoted: gedeyeer })
